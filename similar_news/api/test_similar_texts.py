...
from similar_news.api.similar_texts import SimilarTexts
...
if __name__ == '__main__':
    ...
    logging.info(similar_texts.get_similar_news(
        news_url='https://www.bitdefender.com/blog/labs/5-times-more-coronavirus-themed-malware-reports-during-march/',
        news_title="5 Times More Coronavirus-themed Malware Reports during March",
        news_content=test_news_content,
        news_contained_urls=None)
    )
